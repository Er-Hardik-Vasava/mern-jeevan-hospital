...
const Register = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-28 p-10 mb-10 border bg-white rounded-lg shadow-lg">
      ...
      <h3 className="text-center mb-4">Only Admin Can Register!</h3>
      <form onSubmit={handleRegister}>
        ...
        <div className="flex items-center justify-between">
          <button
            type="submit"
            disabled={loading}
            className={`bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-200 ease-in-out ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
          >
